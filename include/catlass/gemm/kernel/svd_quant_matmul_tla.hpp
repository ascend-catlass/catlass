...
struct SmoothQuant {
    ...
    CATLASS_DEVICE_SIMD_VF void ComputeSmoothX(
    ...
    CATLASS_DEVICE_SIMD_VF void ComputeMaxExp(
    ...
    CATLASS_DEVICE_SIMD_VF void ComputeScale(
    ...
    CATLASS_DEVICE_SIMD_VF void ComputeFp4x2(
